...
export default function Navigation() {
    const {showComponent, handleUploadComplete, handleLoginContext, dashboard, setDashboard} = useUploadContext();
        ...
        <nav className="navigation">
            <div className="nav-logo">
                <p className="nav-logo-text">
                    ...
                    OWER{" "}
                    <text style={{color: "#8080D7"}}>O</text>
                    F{" "}
                    <text style={{color: "#8080D7"}}>B</text>
                    ABEL
                </p>
            </div>
            <div className={`nav-links ${isMobileMenuOpen ? "open" : ""}`}>
                ...
                {!dashboard && <div className="nav-links-item" onClick={handleDashboard}>
                    <p className="nav-links-text">DASHBOARD</p>
                </div>}
